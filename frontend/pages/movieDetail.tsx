  ...
  return (
    <div className="relative h-full w-full bg-black overflow-x-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex-1 flex p-8 gap-8">
          ...
          <div className="w-80 flex-shrink-0">
            ...
            <div className="mt-6 space-y-3">
              <button className="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-3 transition-all transform hover:scale-105">
        ...
        {/* Comments Section */}
        <div className="bg-black backdrop-blur-sm border-t border-gray-700">
          <div className="p-8">
